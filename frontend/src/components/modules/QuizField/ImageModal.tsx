...
function ImageModal({
  ...
  return (
    <div className="fixed inset-0 bg-blackNew-50/50 flex items-center justify-center z-50 font-roboto">
      <div className="bg-white dark:bg-secondary-900 dark:border dark:border-secondary-50 w-[90%] max-w-[1000px] p-6 rounded-lg shadow-lg">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {questionData.map((option) => {
            const selected = localSelected.some(
        ...
        <div className="flex justify-end gap-4 mt-6">
          ...
          <button
            ...
            className="bg-primary-500 hover:bg-primary-300 text-white font-semibold py-2 px-4 rounded-lg"
          >
            Submit
          </button>
        </div>
