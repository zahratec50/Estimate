...
//   // تعیین نوع کاربر
//   useEffect(() => {
//     if (!isRegistered && preQuizAnswers.length === 7) {
...
//   // تعیین نوع کاربر با توجه به جواب سوال سوم (ایندکس 2)
//   useEffect(() => {
//     if (!isRegistered && preQuizAnswers.length === 7) {
//       // در حالت جدید جواب‌ها به صورت رشته ذخیره می‌شوند، پس باید متن جواب را بررسی کنیم
//       const budgetAnswerObj = preQuizAnswers.find(
//         (answer) => answer.question === "What is the capital of France?" || answer.questionIndex === 2
//       );

//       // مثال فرضی برای تشخیص userType بر اساس متن جواب — شما این قسمت را با منطق خودتون تنظیم کنید
...
//   // همگام‌سازی با سرور وقتی ثبت‌نام شده باشد
//   useEffect(() => {
//     if (isRegistered) {
//       syncWithServer();
//     }
