...
export default function Topbar({ onMenuClick, onHelpToggle }: TopbarProps ) {
  ...
  return (
    <>
      {/* Topbar */}
      <header className="flex items-center justify-between sm:justify-end px-2 py-3 sm:px-6 shadow-md relative z-30 bg-white">
        ...
        <div className="flex items-center space-x-3 md:space-x-6 text-secondary-700 text-sm md:text-base font-medium ml-auto">
      ...
      <div
        className={clsx(
          "fixed top-0 right-0 h-full w-[320px] bg-white shadow-lg z-50 transition-transform duration-300 border-l border-gray-200",
      ...
      >
        ...
        <div>
          ...
          <div className="flex items-center gap-2 m-6 border rounded-md p-2">
            ...
            <input type="text" placeholder="Search..." className="text-sm placeholder:text-sm placeholder:text-secondary-300 outline-none" />
          </div>
        </div>
