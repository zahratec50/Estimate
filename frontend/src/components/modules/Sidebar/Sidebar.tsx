...
//     queryFn: async () => {
//       const response = await axios.get(`/api/saveFirstQuiz?userId=${userId}`);
...
//       router.push("/firstQuiz/1"); // هدایت به فرست‌کوییز
//     } else {
//       router.push(`/dashboard/profile/${quizzes[0]._id}`); // هدایت به پروفایل با quizId
//     }
//     handleClose();
//   };
...
//     try {
//       await fetch("/api/auth/signout", { method: "POST" });
//       await axios.post("/api/auth/clearRefreshToken"); // Clear refresh token
//       router.push("/");
//       handleClose();
//     } catch (error) {
//       console.error("Sign out failed:", error);
...
//               className="text-white hover:text-primary-100 text-left"
//               disabled={isLoading}
//             >
//               Profile
//             </button>
