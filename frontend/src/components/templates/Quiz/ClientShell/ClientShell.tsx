...
//   const setCurrentStepFirstQuiz = useAppStore(
//     (state) => state.setCurrentStepFirstQuiz
//   );
//   const setCurrentStepMainQuiz = useAppStore(
//     (state) => state.setCurrentStepMainQuiz
//   );

//   const syncFirstQuizWithServer = useAppStore(
//     (state) => state.syncFirstQuizWithServer
//   );
//   const syncMainQuizWithServer = useAppStore(
//     (state) => state.syncMainQuizWithServer
//   );
...
//   // Sync with server
//   // --------------------
//   const currentStepFirstQuiz = useAppStore(
//     (state) => state.currentStepFirstQuiz
//   );
...
//           <TopbarActions isFirstQuiz={isFirstQuiz} isHelpOpen={isHelpOpen} />
//         )}
