  ...
  return (
    <div className="w-full h-[558px]">
      <div className="w-full h-full flex flex-col lg:flex-row items-center justify-between px-5 xl:px-0">
        <div className={`w-full lg:w-1/2 h-full bg-primary-200 dark:bg-secondary-600 rounded-2xl mb-10 lg:mb-0 ${id%2===0 ? 'order-2 lg:order-1' : 'order-1 lg:order-2'}`}>
          <span></span>
        </div>
        ...
        <div className={`w-full lg:w-1/2 flex items-center ${id%2===0 ? 'order-2 justify-start lg:justify-end' : 'order-1 justify-start'}`}> 
          <div className="w-[459px] h-60 flex flex-col gap-5 lg:gap-9">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center gap-5">
              <button className="w-36 py-3 bg-primary-500 dark:bg-secondary-600 hover:bg-primary-600 hover:dark:bg-secondary-500 text-white rounded-md">
