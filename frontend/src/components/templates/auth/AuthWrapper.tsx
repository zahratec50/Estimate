...
//  const { loginMethod, setLoginMethod } = useAppStore();
...
//               {/* فقط موبایل */}
//               <img
//                 src="/images/Frame 1597883540.png" // تصویر مخصوص موبایل
...
//             <button onClick={() => handleSocialLogin("google")} className="flex-1 h-11 border rounded-lg flex items-center justify-center gap-2 hover:bg-gray-100">
//               <FcGoogle className="text-xl" /> Google
//             </button>
//             <button onClick={() => handleSocialLogin("apple")} className="flex-1 h-11 border rounded-lg flex items-center justify-center gap-2 hover:bg-gray-100">
