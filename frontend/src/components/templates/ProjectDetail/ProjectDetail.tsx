...
//   return (
//     <div className={`p-6 dark:bg-secondary-800 rounded-2xl ${lightboxOpen? '' : 'space-y-8'}`}>
//       {/* Stats */}
//       <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
//         <StatsCard label="Estimated Cost" value={`$${estimatedCost}`} />
//         <StatsCard label="Estimated Time" value={`${estimatedTime} hours`} />
//       </div>
...
//       <button className="hover:bg-gray-100 py-2 px-3 rounded-lg">
//         <Link href='/dashboard/projectStart' className="flex items-center justify-center gap-2 font-bold">
