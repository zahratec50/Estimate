...
//           <div className="sm:w-72 flex items-center border border-gray-300 rounded-lg focus-within:border-px focus-within:border-blue-500 pl-1">
//             <CiSearch className="size-5" />
//             <input
//               type="text"
//               placeholder="Search by name or description..."
//               className="w-full sm:w-64 px-4 py-2 outline-none"
//               value={search}
//               onChange={(e) => {
...
//                   : "border border-gray-300 hover:bg-gray-100"
//               }`}
//               onClick={() => { setFilter("completed"); setVisibleCount(PAGE_SIZE); }}
//             >
//               Completed
//             </button>
//             <button
...
//                   : "border border-gray-300 hover:bg-gray-100"
//               }`}
//               onClick={() => { setFilter("inProgress"); setVisibleCount(PAGE_SIZE); }}
//             >
//               In Progress
//             </button>
//           </div> */}
...
//           <div className="w-48">
//             <label htmlFor="projectFilter" className="sr-only">
//               Filter Projects
//             </label>
//             <select
//               id="projectFilter"
//               value={filter}
//               onChange={(e) => {
//                 setFilter(e.target.value as "all" | "completed" | "inProgress");
//                 setVisibleCount(PAGE_SIZE);
//               }}
//               className="block w-full px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-700 focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
//             >
...
//           <button
//             onClick={downloadCSV}
//             className="px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-900 mt-2 sm:mt-0"
//           >
//             Download CSV
//           </button>
//         </div>
