...
//       // ۳) ارسال به Socket بعد از ذخیره
...
//   return (
//     <div className="min-w-[700px] flex p-2 mx-8 bg-white border border-gray-300 rounded-full dark:border-secondary-700 gap-2 focus-within:border-gray-400 mb-2">
//       <input
//         value={message}
//         onChange={(e) => {
